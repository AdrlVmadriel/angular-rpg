...
export const getCombatLoading = createSelector(
  sliceCombatState,
  sliceCombatLoading
);
...
export const getSpritesLoaded = createSelector(
  sliceSpritesState,
  sliceSpritesLoaded
);
export const getSpriteMap = createSelector(
  sliceSpritesState,
  sliceSpritesById
);
...
export const entitiesToArray = (
  object: Immutable.Map<string, BaseEntity>,
...
// Beings
export const getEntityBeingById = createSelector(
  sliceEntitiesState,
  sliceEntityBeings
);
...
// Items
export const getEntityItemById = createSelector(
  sliceEntitiesState,
  sliceEntityItems
);
export const getEntityItemIds = createSelector(
  sliceEntitiesState,
  sliceEntityItemIds
);
...
export const getGameInventoryIds = createSelector(
  sliceGameState,
  sliceInventoryIds
);
export const getGamePartyIds = createSelector(
  sliceGameState,
  slicePartyIds
);
export const getGamePartyGold = createSelector(
  sliceGameState,
  sliceGold
);
export const getGamePartyPosition = createSelector(
  sliceGameState,
  slicePosition
);
export const getGameShipPosition = createSelector(
  sliceGameState,
  sliceShipPosition
);
export const getGameBoardedShip = createSelector(
  sliceGameState,
  sliceBoardedShip
);
...
export const getGameCombatZone = createSelector(
  sliceGameState,
  sliceCombatZone
);
export const getGameBattleCounter = createSelector(
  sliceGameState,
  sliceBattleCounter
);
export const getGameKeyData = createSelector(
  sliceGameState,
  sliceGameStateKeyData
);
 ...
 */
export const getGameDataLoaded = createSelector(
  sliceGameDataState,
  sliceGameDataLoaded
);
/**
 ...
 */
export function gameDataToArray<T = ITemplateId>(
  object: Immutable.Map<string, T>,
  ids: Immutable.List<string>
): Immutable.List<T> {
  return ids.map((id: string) => object.get(id)).toList();
}

export const getGameDataForType = (type: string) => {
  return createSelector(
    sliceGameDataState,
    sliceGameDataType(type)
  );
};

export const getGameDataWeaponsById = createSelector(
  sliceGameDataState,
  sliceWeapons
);
export const getGameDataWeaponIds = createSelector(
  sliceGameDataState,
  sliceWeaponIds
);
/** Select an array of weapons */
export const getGameDataWeapons = createSelector(
  getGameDataWeaponsById,
  getGameDataWeaponIds,
  gameDataToArray
);

export const getGameDataArmorsById = createSelector(
  sliceGameDataState,
  sliceArmors
);
export const getGameDataArmorIds = createSelector(
  sliceGameDataState,
  sliceArmorIds
);
/** Select an array of armors */
export const getGameDataArmors = createSelector(
  getGameDataArmorsById,
  getGameDataArmorIds,
  gameDataToArray
);

export const getGameDataItemsById = createSelector(
  sliceGameDataState,
  sliceItems
);
export const getGameDataItemIds = createSelector(
  sliceGameDataState,
  sliceItemIds
);
/** Select an array of items */
export const getGameDataItems = createSelector(
  getGameDataItemsById,
  getGameDataItemIds,
  gameDataToArray
);

export const getGameDataEnemiesById = createSelector(
  sliceGameDataState,
  sliceEnemies
);
export const getGameDataEnemiesIds = createSelector(
  sliceGameDataState,
  sliceEnemiesIds
);
/** Select an array of items */
export const getGameDataEnemies = createSelector(
  getGameDataEnemiesById,
  getGameDataEnemiesIds,
  gameDataToArray
);

export const getGameDataMagicsById = createSelector(
  sliceGameDataState,
  sliceMagics
);
export const getGameDataMagicIds = createSelector(
  sliceGameDataState,
  sliceMagicIds
);
/** Select an array of magics */
export const getGameDataMagics = createSelector(
  getGameDataMagicsById,
  getGameDataMagicIds,
  gameDataToArray
);

export const getGameDataClassesById = createSelector(
  sliceGameDataState,
  sliceClasses
);
export const getGameDataClassesIds = createSelector(
  sliceGameDataState,
  sliceClassesIds
);
/** Select an array of game character classes */
export const getGameDataClasses = createSelector(
  getGameDataClassesById,
  getGameDataClassesIds,
  gameDataToArray
);

export const getGameDataRandomEncountersById = createSelector(
  sliceGameDataState,
  sliceRandomEncounters
);
export const getGameDataRandomEncounterIds = createSelector(
  sliceGameDataState,
  sliceRandomEncounterIds
);
/** Select an array of random combat encounters */
export const getGameDataRandomEncounters = createSelector(
  getGameDataRandomEncountersById,
  getGameDataRandomEncounterIds,
  gameDataToArray
);

export const getGameDataFixedEncountersById = createSelector(
  sliceGameDataState,
  sliceFixedEncounters
);
export const getGameDataFixedEncounterIds = createSelector(
  sliceGameDataState,
  sliceFixedEncounterIds
);
/** Select an array of fixed combat encounters */
export const getGameDataFixedEncounters = createSelector(
  getGameDataFixedEncountersById,
  getGameDataFixedEncounterIds,
  gameDataToArray
);
